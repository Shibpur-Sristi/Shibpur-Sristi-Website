<section class="top-bar">
    <div class="container">
        ...
        <div class="left-text pull-left">
            <p><span>Reg. No. :</span> <b>S/2L 26147 of 2014-15</b></p>
        </div> <!-- /.left-text -->

        <div class="social-icons pull-right">
            <ul>
                <li><a href="https://www.facebook.com/shibpursristi" target="_blank"><i class="fa fa-facebook"></i></a>
                </li>
                <li><a href="https://twitter.com/shibpursristi14" target="_blank"><i class="fa fa-twitter"></i></a></li>
                <li><a href="https://www.youtube.com/channel/UCLhhn_H9iWcwSTI4MalAa-w" target="_blank"><i
                            class="fa fa-youtube"></i></a></li>
                <li><a href="https://www.linkedin.com/company/shibpur-sristi/" target="_blank"><i
...
<header class="header">
    <div class="container">
        <div class="logo pull-left">
            <a href="index.html">
                <img src="images/logo.png" alt="Awesome Image" style="max-width: 50%;" />
            </a>
        </div>
        <div class="header-right-info pull-right clearfix">
            ...
            <div class="single-header-info" id="header-donate">
                <a class="thm-btn" href="donate.php">Donate Now</a>
            </div>
        </div>
    </div>
</header> <!-- /.header -->
    ...
    <div class="container">
        <div class="navigation">
            ...
            <div class="nav-footer">
                <img src="images/logo.png" alt="Awesome Image" style="max-width: 50%;" />
                <button data-target="slide-out" class="sidenav-trigger"><i class="fa fa-bars"></i></button>
            </div>
        </div>
    </div>
</nav> <!-- /.mainmenu-area -->
